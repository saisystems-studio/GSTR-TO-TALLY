...
def result_row(gstin, status, party=None, reason=""):
    ...
    sandbox_lookup = ({
        ...
        "environment": party_diagnostics.get("environment", ""),
        "base_url": party_diagnostics.get("base_url", ""),
        "credential_type": party_diagnostics.get("credential_type", ""),
        "authentication_status": party_diagnostics.get("authentication_status", ""),
        "taxpayer_lookup_http_status": party_diagnostics.get("http_status"),
        "lookup_failed": bool(isinstance(party_diagnostics.get("http_status"), int) and party_diagnostics.get("http_status") >= 400),
        "party_details_complete": bool(normalized.get("party_details_complete")),
        "provider_message": party_diagnostics.get("provider_message") or "",
        "token_refreshed": bool(party_diagnostics.get("token_refreshed")),
